...
const timeline = [
  {
    icon: MessageSquare,
    title: "Tech Talk",
    desc: "Chia sẻ kiến thức, xu hướng công nghệ từ các chuyên gia và đối tác uy tín.",
  },
  {
    icon: Rocket,
    title: "Startup Bootcamp",
    desc: "Chương trình huấn luyện giúp bạn xây dựng ý tưởng khởi nghiệp vững chắc.",
  },
  {
    icon: Code,
    title: "Hackathon",
    desc: "Sân chơi lập trình, giải quyết vấn đề thực tế trong thời gian ngắn cùng đội nhóm.",
  },
  {
    icon: Users,
    title: "Mentor Day",
    desc: "Kết nối 1-1 với mentor để nhận định hướng và lộ trình phát triển cá nhân.",
  },
  {
    icon: Presentation,
    title: "Demo Day",
    desc: "Trình bày dự án trước hội đồng tư vấn và cơ hội nhận đầu tư từ doanh nghiệp.",
  },
];
...
export default function ProgramsSection() {
  return (
    <section
      id="activities"
      className="py-16 sm:py-20 md:py-24 bg-slate-50 overflow-hidden"
    >
      <div className="container-wide">
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 md:mb-20">
          <h2 className="text-blue-600 font-black uppercase tracking-widest text-xs mb-3 sm:mb-4">
            CHƯƠNG TRÌNH & DỰ ÁN
          </h2>
          <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-slate-900 mb-4 sm:mb-6 italic">
            Hoạt động & Hoài bão
          </h3>
          <p className="text-sm sm:text-base md:text-lg text-slate-600 italic">
            Chúng tôi tạo ra các sân chơi chuyên nghiệp để sinh viên rèn luyện
            kỹ năng và tinh thần khởi nghiệp.
          </p>
        </div>
          ...
          <div className="relative flex justify-between">
            {timeline.map((item, index) => (
              ...
              >
                ...
                <h4 className="text-lg font-black text-slate-900 mb-2 text-center">
                  {item.title}
                </h4>
                <p className="text-slate-400 text-xs italic text-center px-2">
                  {item.desc}
                </p>
              </motion.div>
            ))}
